Spree::Product.class_eval do
  attr_accessible :tire_fr_id, :tire_speed_code_id, :tire_tttl_id, :tire_profile_id, 
  :tire_ic_id, :tire_innertube_id, :tire_width_id
  attr_accessible :pvp3, :pvp7, :pvp9, :pvp12, :count_on_hand
